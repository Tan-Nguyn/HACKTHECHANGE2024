...
function Header({ children }) {
  return (
    <>
      ...
      <header className="bg-black flex items-center justify-center py-6 fixed top-0 w-screen max-w-screen-2xl mx-auto"></header>
      <SignedOut>
      ...
      <SignedIn>
        <header className="bg-black flex flex-row justify-between items-center px-6 py-6 fixed w-screen max-w-screen-2xl top-0 mx-auto">
          <img
            onClick={() => {
              navigate("/");
            }}
